...
#define CW_STACK_STR(name, ...) \
    ...
    namespace spoof {
        ...
        template<typename Ret, typename... Args>
        CW_FORCEINLINE spoofed_call<Ret, Args...> make_spoofed_call(Ret(*f)(Args...)) {
            return spoofed_call<Ret, Args...>{f};
        }
    }

    #define CW_SPOOF_CALL(func) (cloakwork::spoof::make_spoofed_call(&func))
#else
    namespace spoof {
